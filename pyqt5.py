...
class Pencere(QtWidgets.QWidget):
    ...
    def init_ui(self):
        ...
        self.kayit.clicked.connect(self.click1)
    ...
    def login(self):
        ...
        if sender.text()=="Giriş Yap":
            ...
            if len(data) == 0:
                ...
                self.yazı_alanı.setText("Hoşgeldin"+ad)
    def click1(self,yenik,yenip):

        self.cursor.execute("INSERT INTO üyeler VALUES(?,?)", (yenik,yenip))
        self.baglanti_olustur.commit()
app=QtWidgets.QApplication(sys.argv)

pencere=Pencere()
sys.exit(app.exec_())
kullanici_adi = input("ada")
parola = input("aaa")
pencere.click1(kullanici_adi,parola)
